  ...
  return (
    <section id="hero" className="bg-gray-900 text-gray-100 min-h-screen flex flex-col justify-center items-center mt-14 px-6 py-12 md:py-0">
      <div className="flex flex-col-reverse md:flex-row w-full justify-center items-center md:items-start gap-12">
        {/* Left Side */}
        <div className="md:w-1/2 flex flex-col justify-center text-center md:text-left space-y-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold">Hi, I’m Dipesh Thing 👋</h1>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold h-10 text-blue-500">
            {displayText}
            <span className="border-r-2 border-red-500 ml-1 animate-pulse"></span>
          </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center mt-12">
        <div className="bg-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
          <FaBriefcase className="w-10 h-10 text-blue-500 mx-auto mb-4" />
          <h2 className="text-2xl font-bold text-blue-500">2+ Years</h2>
          <p className="text-gray-300 text-sm mt-2">Building scalable web apps with MERN stack.</p>
        </div>
        <div className="bg-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
          <FaCode className="w-10 h-10 text-green-500 mx-auto mb-4" />
          <h2 className="text-2xl font-bold text-green-500">10+ Projects</h2>
          <p className="text-gray-300 text-sm mt-2">Delivered EMS, LMS, educational platforms.</p>
        </div>
        <div className="bg-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
          <FaHeart className="w-10 h-10 text-yellow-400 mx-auto mb-4 animate-pulse" />
          <h2 className="text-2xl font-bold text-yellow-400">100% Dedication</h2>
          <p className="text-gray-300 text-sm mt-2">Creating user-first designs & seamless UX.</p>
        </div>
        <div className="bg-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
          <FaGlobe className="w-10 h-10 text-purple-500 mx-auto mb-4 animate-spin-slow" />
          <h2 className="text-2xl font-bold text-purple-500">Open Source</h2>
          <p className="text-gray-300 text-sm mt-2">Contributing to the dev community worldwide.</p>
        </div>
      </div>
